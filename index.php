              ...
              <div class="col-12">
                  <nav class="main-nav">
                      ...
                      <a href="index.html" class="logo">
                          <img src="assets/images/logo.jfif" class="logo_image twit" alt="">
                      </a>
                      <!-- ***** Logo End ***** -->
                      <!-- ***** Menu Start ***** -->
                      <ul class="nav">
      ...
      <div class="row">
        <div class="col-lg-6 align-self-center">
          <div class="header-text">
            <h6>Welcome to our Twitter sentiments</h6>
            <h2>Best place to share <em>Twitter sentiments!</em></h2>
            <div class="main-button-gradient">
              <div class="scroll-to-section"><a href="login.html">Join Us Now!</a></div>
            </div>
          </div>
        </div>
        <div class="col-lg-6">
          ...
          <div class="owl-service-item owl-carousel">
            <div class="item">
              <div class="service-item">
                ...
                <p>Read the sentiments of the tweets.</p>
              </div>
            </div>
            <div class="item">
              <div class="service-item">
                ...
                <h4>safety</h4>
                <p>Save information and not share it.</p>
              </div>
            </div>
            <div class="item">
              <div class="service-item">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-5 align-self-center">
          <h6>Get services!</h6>
          <h4>many services and the</h4>
          <p>We are glad to have you join us, do not miss this opportunity.</p>
          <div class="white-button">
            <a href="login.php">Join US Now!</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="contact-us" id="contact-section">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-4">
          <form id="contact" action="assets/php/Testimonials.php" method="post">
            <div class="row">
              <div class="col-lg-12">
                <div class="section-heading">
                  <h6>Contact us</h6>
                  <h4>Say <em>Hello</em></h4>
                  <p>Leave us and our visitors a message</p>
                </div>
              </div>
              <div class="col-lg-12">
                <fieldset>
              ...
              <div class="col-lg-12">
                <fieldset>
                  <button type="submit" name="send" id="form-submit" class="main-gradient-button">Send Message</button>
                </fieldset>
              </div>
            </div>
          </form>
        ...
        <div class="col-lg-12">
          <p class="copyright">Copyright © 2022 Twitter sentiments Co., Ltd. All Rights Reserved. 
